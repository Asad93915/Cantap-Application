...
import '../../admin_modules/admin_drawer_screen.dart';

class TecaherViewTutorialsScreen extends StatefulWidget {
  final bool show;
   TecaherViewTutorialsScreen({this.show=true});

  @override
  State<TecaherViewTutorialsScreen> createState() => _TecaherViewTutorialsScreenState();
}

class _TecaherViewTutorialsScreenState extends State<TecaherViewTutorialsScreen> {
  @override
  Widget build(BuildContext context) {
    return widget.show?TeacherTutorials():
        Scaffold(
          ...
          appBar: AppBar(
            title: Text("Teacher Tutorials View",style: TextStyle(
              color: Colors.white
            ),),
          ),
...
class TeacherTutorials extends StatefulWidget {
  const TeacherTutorials({Key? key}) : super(key: key);

  @override
  State<TeacherTutorials> createState() => _TeacherTutorialsState();
}

class _TeacherTutorialsState extends State<TeacherTutorials> {
  int ?selectedClass;
